...
// Tests require SGBTLearner and StreamingLinearModel which live in the full
// `irithyll` crate, not in `irithyll-core`. These tests are exercised via the
// re-export layer in `irithyll::ensemble::stacked`.
