...
/// assert!(crate::math::abs((sched.learning_rate(1000, 0.1) - 0.05)) < f64::EPSILON);
/// ```
#[derive(Clone, Debug)]
...
/// assert!(crate::math::abs((sched.learning_rate(200, 0.0) - 0.01)) < 1e-12);
/// ```
#[derive(Clone, Debug)]
...
/// assert!(crate::math::abs((sched.learning_rate(2, 0.0) - 0.81)) < 1e-12);
/// ```
#[derive(Clone, Debug)]
...
/// assert!(crate::math::abs((sched.learning_rate(0, 0.0) - 0.1)) < 1e-12);
/// // Midpoint → min_lr.
/// assert!(crate::math::abs((sched.learning_rate(50, 0.0) - 0.01)) < 1e-12);
/// // Full period → back to max_lr.
/// assert!(crate::math::abs((sched.learning_rate(100, 0.0) - 0.1)) < 1e-12);
/// ```
#[derive(Clone, Debug)]
...
/// assert!(crate::math::abs((sched.learning_rate(5, 0.95) - 0.05)) < 1e-12);
/// ```
#[derive(Clone, Debug)]
